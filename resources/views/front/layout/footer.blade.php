                        ...
                        <div class="col-xxl-3 col-xl-4 col-lg-5 col-md-8">
                            <div class="footer__widget">
                                ...
                                <div class="footer__widget-content">
                                    <p class="footer-text mb-25">DukaMall App is now available on App Store & Google Play. Get it now.</p>
                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                ...
                                <div class="payment-image text-center mb-25">
                                    <a href="#"><img src="{{ asset('front/img/payment/payment.png')}}" alt=""></a>
                                </div>
                                <div class="copy-right-area copy-right-area-2 text-center">
                                    <p>Copyright © <span>DukaMall.</span> All Rights Reserved. Powered by </p>
                                </div>
                            </div>
                        </div>
                    </div>
