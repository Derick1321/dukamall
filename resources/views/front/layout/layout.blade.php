...
<html class="no-js" lang="zxx">
   ...
   <body>
    ...
    <!-- footer-end -->
      ...
      <script src="{{ url('front/owl-carousel.js')}}js/"></script>
      <script src="{{ url('front/magnific-popup.js')}}js/"></script>
      ...
      <script src="{{ url('front/js/wow.js')}}js/"></script>
