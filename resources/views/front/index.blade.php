                    ...
                    <div class="col-xl-7">
                        <div class="swiper-container slider__active pb-30">
                            <div class="slider-wrapper swiper-wrapper">
                                <div class="single-slider swiper-slide b-radius-2 slider-height-2 d-flex align-items-center" data-background="{{ asset('front/img/slider/02-slide-1.jpg')}}">
                                ...
                                <div class="single-slider swiper-slide b-radius-2 slider-height-2 d-flex align-items-center" data-background="{{ asset('front/img/slider/02-slide-2.jpg')}}">
                                    <div class="slider-content slider-content-2">
                    ...
                    <div class="col-xl-5">
                        <div class="row">
                            <div class="col-xl-6 col-lg-6 col-md-6">
                                <div class="banner__item p-relative w-img mb-30">
                                    <div class="banner__img b-radius-2">
                                        <a href="#"><img src="{{ asset('front/img/banner/banner-10.jpg') }}" alt=""></a>
                                    </div>
                                    <div class="banner__content banner__content-2">
                                        <h6><a href="#">Canyon <br> Star Raider</a></h6>
                                        <p>Headphone & Audio</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6">
                                <div class="banner__item p-relative w-img mb-30">
                                    <div class="banner__img b-radius-2">
                                        <a href="#"><img src="{{ asset('front/img/banner/banner-11.jpg')}}" alt=""></a>
                                    </div>
                                    <div class="banner__content banner__content-2">
                                        <h6><a href="#">Phone <br> Galaxy S20</a></h6>
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6">
                                <div class="banner__item p-relative w-img mb-30">
                                    <div class="banner__img b-radius-2">
                                        <a href="#"><img src="{{ asset('front/img/banner/banner-13.jpg')}}" alt=""></a>
                                    </div>
                                    <div class="banner__content banner__content-2">
                                        <h6><a href="#">Galaxy <br> Buds Plus</a></h6>
                                        <p>Headphone & Audio</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6">
                                <div class="banner__item p-relative w-img mb-30">
                                    <div class="banner__img b-radius-2">
                                        <a href="#"><img src="{{ asset('front/img/banner/banner-12.jpg')}}" alt=""></a>
                                    </div>
                                    <div class="banner__content banner__content-2">
                                        <h6><a href="#">Chair <br>Swoon Lounge</a></h6>
                                        <p>Headphone & Audio</p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 col-xl-3 col-xxl-2">
                        <div class="product__item product__item-2 b-radius-2 mb-20">
                            <div class="product__thumb fix">
                                <div class="product-image w-img">
                                    <a href="#">
                                        <img src="{{ asset('front/img/product/tp-2.jpg')}}" alt="product">
                                    </a>
                                </div>
                                <div class="product-action product-action-2">
                                    <a href="#" class="icon-box icon-box-1" data-bs-toggle="modal" data-bs-target="#productModalId">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 col-xl-3 col-xxl-2">
                        <div class="product__item product__item-2 b-radius-2 mb-20">
                            <div class="product__thumb fix">
                                <div class="product-image w-img">
                                    <a href="#">
                                        <img src="{{ asset('front/img/product/tp-3.jpg')}}" alt="product">
                                    </a>
                                </div>
                                <div class="product__offer">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 col-xl-3 col-xxl-2">
                        <div class="product__item product__item-2 b-radius-2 mb-20">
                            <div class="product__thumb fix">
                                <div class="product-image w-img">
                                    <a href="#">
                                        <img src="{{ asset('front/img/product/tp-7.jpg')}}" alt="product">
                                    </a>
                                </div>
                                <div class="product-action product-action-2">
                                    <a href="#" class="icon-box icon-box-1" data-bs-toggle="modal" data-bs-target="#productModalId">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 col-xl-3 col-xxl-2">
                        <div class="product__item product__item-2 b-radius-2 mb-20">
                            <div class="product__thumb fix">
                                <div class="product-image w-img">
                                    <a href="#">
                                        <img src="{{ asset('front/img/product/tp-10.jpg')}}" alt="product">
                                    </a>
                                </div>
                                <div class="product-action product-action-2">
                                    <a href="#" class="icon-box icon-box-1" data-bs-toggle="modal" data-bs-target="#productModalId">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 col-xl-3 col-xxl-2">
                        <div class="product__item product__item-2 b-radius-2 mb-20">
                            <div class="product__thumb fix">
                                <div class="product-image w-img">
                                    <a href="#">
                                        <img src="{{ asset('front/img/product/tp-9.jpg')}}" alt="product">
                                    </a>
                                </div>
                                <div class="product-action product-action-2">
                                    <a href="#" class="icon-box icon-box-1" data-bs-toggle="modal" data-bs-target="#productModalId">
            ...
            <div class="container custom-conatiner">
                ...
                <div class="row">
                    <div class="col-xl-2 col-lg-3 col-md-4">
                        <div class="categories__item p-relative w-img mb-30">
                            <div class="categories__img b-radius-2">
                                <a href="#"><img src="{{ asset('front/img/categorie/cat-1.jpg')}}" alt=""></a>
                            </div>
                            <div class="categories__content">
                                <h6><a href="#">Decor & Furniture</a></h6>
                                <p>(7 Products)</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-2 col-lg-3 col-md-4">
                        <div class="categories__item p-relative w-img mb-30">
                            <div class="categories__img b-radius-2">
                                <a href="#"><img src="{{ asset('front/img/categorie/cat-2.jpg')}}" alt=""></a>
                            </div>
                            <div class="categories__content">
                                <h6><a href="#">Smart Phones</a></h6>
                                <p>(12 Products)</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-2 col-lg-3 col-md-4">
                        <div class="categories__item p-relative w-img mb-30">
                            <div class="categories__img b-radius-2">
                                <a href="#"><img src="{{ asset('front/img/categorie/cat-3.jpg')}}" alt=""></a>
                            </div>
                            <div class="categories__content">
                                <h6><a href="#">Fashion & Clothing</a></h6>
                                <p>(5 Products)</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-2 col-lg-3 col-md-4">
                        <div class="categories__item p-relative w-img mb-30">
                            <div class="categories__img b-radius-2">
                                <a href="#"><img src="{{ asset('front/img/categorie/cat-4.jpg')}}" alt=""></a>
                            </div>
                            <div class="categories__content">
                    ...
                    <div class="col-xl-2 col-lg-3 col-md-4">
                        <div class="categories__item p-relative w-img mb-30">
                            <div class="categories__img b-radius-2">
                                <a href="#"><img src="{{ asset('front/img/categorie/cat-5.jpg')}}" alt=""></a>
                            </div>
                            <div class="categories__content">
                                <h6><a href="#">Camera & Photos</a></h6>
                                <p>(7 Products)</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-2 col-lg-3 col-md-4">
                        <div class="categories__item p-relative w-img mb-30">
                            <div class="categories__img b-radius-2">
                                <a href="#"><img src="{{ asset('front/img/categorie/cat-6.jpg')}}" alt=""></a>
                            </div>
                            <div class="categories__content">
                                <h6><a href="#">Speaker & Audio</a></h6>
                                <p>(15 Products)</p>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="features-thum">
                                        <div class="features-product-image w-img">
                                            <a href="#"><img src="{{ asset('front/img/features-product/fpb-1.jpg')}}" alt=""></a>
                                        </div>
                                        <div class="product__offer">
                                            <span class="discount">-15%</span>
                                        </div>
                        ...
                        <div class="single-features-item single-features-item-d single-features-item-d-2 b-radius-2 mb-20">
                            <div class="row  g-0 align-items-center">
                                <div class="col-lg-6">
                                    <div class="features-thum">
                                        <div class="features-product-image w-img">
                                            <a href="#"><img src="{{ asset('front/img/features-product/fpb-2.jpg')}}" alt=""></a>
                                        </div>
                                        <div class="product-action product-action-2">
                                            <a href="#" class="icon-box icon-box-1" data-bs-toggle="modal" data-bs-target="#productModalId">
                                                <i class="fal fa-eye"></i>
                                ...
                                <div class="col-lg-6">
                                    <div class="product__content product__content-d product__content-d-2">
                                        <h6><a href="#">Redmi Note 10 128GB International Model</a></h6>
                                        <div class="rating mb-5">
                                            <ul class="rating-d">
                                                <li><a href="#"><i class="fal fa-star"></i></a></li>
                                                <li><a href="#"><i class="fal fa-star"></i></a></li>
            ...
            <div class="container custom-conatiner">
                <div class="row">
                    <div class="col-xl-4 col-lg-4 col-md-12">
                        <div class="banner__item p-relative w-img mb-30">
                            <div class="banner__img b-radius-2">
                                <a href="#"><img src="{{ asset('front/img/banner/banner-14.jpg')}}" alt=""></a>
                            </div>
                            <div class="banner__content banner__content-2">
                                <h6><a href="#">Microsoft <br> Surface Laptop 14”</a></h6>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-12">
                        <div class="banner__item p-relative mb-30 w-img">
                            <div class="banner__img b-radius-2">
                                <a href="#"><img src="{{ asset('front/img/banner/banner-15.jpg')}}" alt=""></a>
                            </div>
                            <div class="banner__content banner__content-2">
                                <h6><a href="#">Cameras <br>Best Sport Edition </a></h6>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-12">
                        <div class="banner__item p-relative mb-30 w-img">
                            <div class="banner__img b-radius-2">
                                <a href="#"><img src="{{ asset('front/img/banner/banner-16.jpg')}}" alt=""></a>
                            </div>
                            <div class="banner__content banner__content-2">
                                <h6><a href="#">Sneaker <br>Nike Air Max 90 </a></h6>
                        ...
                        <div class="single-features-item single-features-item-d b-radius-2 mb-20">
                            <div class="row  g-0 align-items-center">
                                <div class="col-md-6">
                                    <div class="features-thum">
                                        <div class="features-product-image w-img">
                                            <a href="#"><img src="{{ asset('front/img/features-product/fpsm-1.jpg')}}" alt=""></a>
                                        </div>
                                        <div class="product__offer">
                                            <span class="discount">-15%</span>
                                        </div>
                                ...
                                <div class="single-features-item b-radius-2 mb-20">
                                    <div class="row  g-0 align-items-center">
                                        <div class="col-6">
                                            <div class="features-thum">
                                                <div class="features-product-image w-img">
                                                    <a href="#"><img src="{{ asset('front/img/features-product/fp-1.jpg')}}" alt=""></a>
                                                </div>
                                                <div class="product__offer">
                                                    <span class="discount">-15%</span>
                                                </div>
                                ...
                                <div class="single-features-item b-radius-2 mb-20">
                                    <div class="row  g-0 align-items-center">
                                        <div class="col-6">
                                            <div class="features-thum">
                                                <div class="features-product-image w-img">
                                                    <a href="#"><img src="{{ asset('front/img/features-product/fp-2.jpg')}}" alt=""></a>
                                                </div>
                                                <div class="product__offer">
                                ...
                                <div class="single-features-item b-radius-2 mb-20">
                                    <div class="row  g-0 align-items-center">
                                        <div class="col-6">
                                            <div class="features-thum">
                                                <div class="features-product-image w-img">
                                                    <a href="#"><img src="{{ asset('front/img/features-product/fp-3.jpg')}}" alt=""></a>
                                                </div>
                                                <div class="product__offer">
                                ...
                                <div class="single-features-item b-radius-2 mb-20">
                                    <div class="row  g-0 align-items-center">
                                        <div class="col-6">
                                            <div class="features-thum">
                                                <div class="features-product-image w-img">
                                                    <a href="#"><img src="{{ asset('front/img/features-product/fp-4.jpg')}}" alt=""></a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-6">
