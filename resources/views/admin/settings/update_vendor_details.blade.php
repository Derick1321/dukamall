                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample" action="{{ url('admin/update-vendor-details/personal') }}" method="post" enctype="multipart/form-data">@csrf
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="vendor_country" placeholder="Enter Name"  
                    ...
                    <div class="form-group">
                      ...
                      name="vendor_mobile" value="{{ Auth::guard('admin')->user()->mobile }}" required="" maxlength="10" minlength="10">
                    </div>
                    <div class="form-group">
                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample" action="{{ url('admin/update-vendor-details/business') }}" method="post" enctype="multipart/form-data">@csrf
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="shop_name" placeholder="Enter Name"  
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="shop_mobile" placeholder="Enter 10 Shop Digit Mobile Number" 
                      name="shop_mobile" value="{{ $vendorDetails['shop_mobile']}}"" required="" maxlength="10" minlength="10">
                    </div>
                    <div class="form-group">
                      <label for="business_licence_number">Business Licence Number</label>
                      <input type="text" class="form-control" id="business_licence_number" placeholder="Enter Business Licence"  
                      name="business_licence_number" value="{{ $vendorDetails['shop_country']}}" >
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="pan_number" placeholder="Enter Shop Country"  
                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample" action="{{ url('admin/update-vendor-details/bank') }}" method="post" enctype="multipart/form-data">@csrf
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="account_holder_name" placeholder="Enter Account Name"  
                      name="account_holder_name" value="{{ $vendorDetails['account_holder_name']}}">
                    </div>
                    <div class="form-group">
                      <label for="bank_name">Bank Name</label>
                      <input type="text" class="form-control" id="bank_name" placeholder="Enter Shop Address"  
                      name="bank_name" value="{{ $vendorDetails['bank_name']}}" >
                    </div>
                    <div class="form-group">
                      <label for="account_number">Account Number</label>
                      <input type="text" class="form-control" id="account_number" placeholder="Enter Shop City"  
                      name="account_number" value="{{ $vendorDetails['account_number']}}" >
                    </div>
                    <div class="form-group">
                      <label for="bank_ifsc_code">Bank IFSC Code</label>
                      <input type="text" class="form-control" id="bank_ifsc_code" placeholder="Enter Shop Country"  
