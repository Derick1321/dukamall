                  ...
                  <h4 class="card-title">Personal Information</h4>
                    ...
                    @if(!empty( $vendorDetails['image'] ))
                      <div class="form-group">
                        ...
                        <br>                    
                        <img style="with: 200px;" src="{{ url('admin/images/photos/'.$vendorDetails['image']) }}">
                      </div>
                    @endif
                </div>
              </div>
                  ...
                  <h4 class="card-title">Business Information</h4>
                    ...
                    <!-- @if(!empty( $vendorDetails['vendor_business'] ['address_proof_image'] ))
                      <div class="form-group">
                        <label for="vendor_image">Photo</label>  
                        <br>                    
                        <img style="with: 200px;" src="{{ url('admin/images/proofs/'.$vendorDetails['vendor_business'] ['address_proof_image']) }}">
                      </div>
                    @endif -->
                </div>
              </div>
              ...
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Bank Information</h4>
                    ...
                    <div class="form-group">
                      <label for="vendor_city">Bank IFC Code</label>
